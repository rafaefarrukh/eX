...
server <- function(input, output) {
    ...
    output$ins.eval <- renderPlotly({
        ggplotly(ggplot(ins.graph(), aes(x=val, group = type, fill = type)) +
    ...
    <br><br><b>Teaching Quality:</b> Did you understand the content of the course? Did the instructor help you understand topics you struggled with? 1 is bad and 10 is good.
    <br><br><b>Personality:</b> Did you enjoy your classes? Was the instructor an egoistic maniac? 1 is poor and 10 is great.
